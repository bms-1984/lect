...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_TOK_ID = 3,                     /* "identifier"  */
  YYSYMBOL_TOK_INTEGER = 4,                /* "integer"  */
  YYSYMBOL_TOK_DOUBLE = 5,                 /* "double"  */
  YYSYMBOL_6_ = 6,                         /* '-'  */
  YYSYMBOL_7_ = 7,                         /* '+'  */
  YYSYMBOL_8_ = 8,                         /* '*'  */
  YYSYMBOL_9_ = 9,                         /* '/'  */
...
yysymbol_name (yysymbol_kind_t yysymbol)
{
  ...
  {
  N_("end of file"), N_("error"), N_("invalid token"), N_("identifier"),
  N_("integer"), N_("double"), "'-'", "'+'", "'*'", "'/'", "$accept",
